...
<section class="mag-hero">
  <div class="hero-main">
    ...
    <p class="hero-sub">2026-07-18号 — Claude Code を中心に、実装に効く話題を編集</p>
    <p class="hero-lead">本日 2026-07-18 は、Claude Code を中心に 4 件のトピックをお届けします。Grok が X 上から収集した最新の AI エージェント関連情報です。</p>
  </div>
...
<article class="story-card lead">
  ...
  <h3>Claude Code Fable修正</h3>
  <p class="story-summary">ClaudeDevs公式、Fableモデル選択問題を30分で解決、再起動推奨</p>
  <div class="story-links"><a href="https://x.com/ClaudeDevs/status/2078211065868091768" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>Claude Code内GPT-5.6活用</h3>
  <p class="story-summary">TheoがClaude CodeでCodex/GPT比較解説、効率的なサブエージェント設定Tips</p>
  <div class="story-links"><a href="https://x.com/theo/status/2078217355780624864" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
...
<article class="story-card secondary">
  ...
  <h3>DeNA Claude Code導入</h3>
  <p class="story-summary">DeNAのチームClaude Code文化・SDDワークフロー実例、非エンジニア対応ガードレール</p>
  <div class="story-links"><a href="https://x.com/SuguruKun_ai/status/2077994194908631362" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
</div>
  </div>
...
<article class="story-card brief">
  ...
  <h3>Claude Codeマルチエージェント</h3>
  <p class="story-summary">Claude Code開発者が1人でAIチーム運用、並列セッション・PR自動化実践例</p>
  <div class="story-links"><a href="https://x.com/sairahul1/status/2078181481768435882" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
</div>
</section>
