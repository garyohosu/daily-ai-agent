...
<article class="story-card lead">
  ...
  <h3>Claude Codeで会計ソフト開発</h3>
  <p class="story-summary">複式簿記アプリをClaude Codeで3日弱作成。写真から仕訳自動化の実践例。</p>
  <div class="story-links"><a href="https://x.com/snakajima/status/2053564278695674310" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>17体エージェント設計</h3>
  <p class="story-summary">Claude Codeでクライアントワーク自動化。17エージェント一発通過の設計Tips。</p>
  <div class="story-links"><a href="https://x.com/ai_shinobix/status/2053524488592224340" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card brief">
  ...
  <h3>Claude Codeで高専ニュース</h3>
  <p class="story-summary">朝ルーチンにClaude Code活用。ニュース検索と投稿原稿自動化の日常Tips。 ...</p>
  <div class="story-links"><a href="https://x.com/michael20250101/status/2053552333783789856" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
</div>
</section>
