...
<article class="story-card lead">
  ...
  <h3>Claude制限回避Tips</h3>
  <p class="story-summary">トークン量減でClaude制限回避10選。日本語実践解説</p>
...
<article class="story-card secondary">
  ...
  <h3>Codex企業統合事例</h3>
  <p class="story-summary">RazorpayがOpenAI Codexにネイティブ埋め込み。支払い自動化</p>
  <div class="story-links"><a href="https://x.com/shashank_kr/status/2041471542249595168" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>AIエージェント判断力</h3>
  <p class="story-summary">Claude/Codex用アニメ比較レッスン。判断スキル向上Tips</p>
  <div class="story-links"><a href="https://x.com/emilkowalski/status/2041501257290969441" target="_blank" rel="noopener">Xポスト</a></div>
