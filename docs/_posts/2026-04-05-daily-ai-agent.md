...
<article class="story-card lead">
  ...
  <h3>Claude Microsoft 365連携</h3>
  <p class="story-summary">全プランでOutlook・OneDrive・SharePoint接続、企業採用加速</p>
  <div class="story-links"><a href="https://x.com/claudeai/status/2040086268562842097" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>Claude Code AIデザイン機能</h3>
  <p class="story-summary">既存デザインシステム完全一致UI生成ツール追加</p>
