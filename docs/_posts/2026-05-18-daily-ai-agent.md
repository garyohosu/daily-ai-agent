...
<section class="mag-hero">
  <div class="hero-main">
    ...
    <p class="hero-sub">2026-05-18号 — Claude Code・AI Agents を中心に、実装に効く話題を編集</p>
    <p class="hero-lead">本日 2026-05-18 は、Claude Code・AI Agents を中心に 3 件のトピックをお届けします。Grok が X 上から収集した最新の AI エージェント関連情報です。</p>
  </div>
...
<article class="story-card lead">
  ...
  <h3>Claudeエージェント構築講座</h3>
  <p class="story-summary">Anthropic公式2時間講座要約。端末・記憶・幻覚防止を実装。</p>
  <div class="story-links"><a href="https://x.com/nowlovepan/status/2056026498969284691" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>Claude Code 無料無制限</h3>
  <p class="story-summary">NVIDIA APIでClaude Codeを無料化。オープンソース2分設定。</p>
  <div class="story-links"><a href="https://x.com/dr_cintas/status/2056077614113325373" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>Claude Codeトークン最適化</h3>
  <p class="story-summary">73%無駄トークン特定。CLAUDE.md肥大化など30秒修正法。</p>
  <div class="story-links"><a href="https://x.com/sairahul1/status/2056050387678024143" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
</div>
  </div>
