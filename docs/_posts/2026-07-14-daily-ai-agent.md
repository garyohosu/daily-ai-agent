...
<article class="story-card lead">
  ...
  <h3>New features and 21 new voices in Voice Agent Builder</h3>
  <p class="story-summary">Agent transfers, custom MCPs, speech controls, and more.

21 new voices, multi-agent transfers, custom MCPs

Hi hantani,

We heard your feedback, and we've been rapidly adding new features to the
Voi</p>
...
<article class="story-card brief">
  ...
  <h3>AIエージェント実践</h3>
  <p class="story-summary">Claude Codeでアプリ作成。AIがPC操作して業務完遂する時代の実例。</p>
  <div class="story-links"><a href="https://x.com/tsuntsun2914/status/2076563885960884555" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>AI エージェント全般に影響しうるトピック。動向把握に。</div>
</article>
...
<article class="story-card brief">
  ...
  <h3>SDD開発フロー</h3>
  <p class="story-summary">Claude Code/Codex向けspec-driven開発：調査→設計→計画→実装→検証の手順。</p>
  <div class="story-links"><a href="https://x.com/santtiagom_/status/2076760731773448509" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
</div>
</section>
