...
<section class="mag-hero">
  <div class="hero-main">
    ...
    <p class="hero-sub">2026-06-01号 — Claude Code・AI Agents を中心に、実装に効く話題を編集</p>
    <p class="hero-lead">本日 2026-06-01 は、Claude Code・AI Agents を中心に 4 件のトピックをお届けします。Grok が X 上から収集した最新の AI エージェント関連情報です。</p>
  </div>
...
<article class="story-card lead">
  ...
  <h3>Claude Code実践リソース集</h3>
  <p class="story-summary">Skills・CLAUDE.md・MCPなど公式無料ガイドまとめ</p>
  <div class="story-links"><a href="https://x.com/eng_khairallah1/status/2060824760859431275" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>Claude CodeでHTML→PPT変換</h3>
  <p class="story-summary">エージェント生成HTMLを自動PowerPoint化、ローカル編集可</p>
  <div class="story-links"><a href="https://x.com/taiyo_ai_gakuse/status/2060710848356921706" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
...
<article class="story-card secondary">
  ...
  <h3>Claude Codeプロンプト術動画</h3>
  <p class="story-summary">構築エンジニアが28分で実践パターン解説、CLAUDE.md活用</p>
  <div class="story-links"><a href="https://x.com/keitijeon/status/2060993442826846440" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
</div>
  </div>
...
<article class="story-card brief">
  ...
  <h3>AIエージェント構築の誤解</h3>
  <p class="story-summary">Skills追加だけでエージェント構築と謳う事例に注意喚起</p>
  <div class="story-links"><a href="https://x.com/taiyo_ai_gakuse/status/2060941235775545474" target="_blank" rel="noopener">Xポスト</a></div>
