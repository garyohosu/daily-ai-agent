...
<article class="story-card lead">
  ...
  <h3>OpenAI SWE-Bench批判</h3>
  <p class="story-summary">コーディングベンチマークの飽和を指摘、信頼性低下を警告</p>
  <div class="story-links"><a href="https://x.com/OpenAI/status/2074958149426241894" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card brief">
  ...
  <h3>Agent Skills公開共有</h3>
  <p class="story-summary">実用的AIエージェントスキル集をGitHubで公開、開発者必見</p>
  <div class="story-links"><a href="https://x.com/RoundtableSpace/status/2074557810910826564" target="_blank" rel="noopener">Xポスト</a></div>
