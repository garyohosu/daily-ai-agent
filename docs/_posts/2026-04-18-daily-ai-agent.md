...
<article class="story-card lead">
  ...
  <h3>Claude Design発表</h3>
  <p class="story-summary">Opus 4.7駆動でプロンプトからデザイン生成。PPTX/HTML出力可</p>
  <div class="story-links"><a href="https://x.com/masahirochaen/status/2045160344675561824" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>OpenAI Codex大型更新</h3>
  <p class="story-summary">Mac操作・90ツール連携・自律タスク実行。開発全自動化へ</p>
