...
<section class="mag-hero">
  <div class="hero-main">
    ...
    <p class="hero-sub">2026-03-19号 — Claude Code・Enterprise を中心に、実装に効く話題を編集</p>
    <p class="hero-lead">本日 2026-03-19 は、Claude Code・Enterprise を中心に 5 件のトピックをお届けします。Grok が X 上から収集した最新の AI エージェント関連情報です。</p>
  </div>
...
<article class="story-card lead">
  ...
  <h3>Code with Claude公式会議</h3>
  <p class="story-summary">東京開催含む開発者カンファレンス。ワークショップ・デモ登録開始</p>
  <div class="story-links"><a href="https://x.com/claudeai/status/2034308517964956051" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>職人Claude Code実例</h3>
  <p class="story-summary">配管専門家が図面解析アプリ構築。作業時間1/10の実務効率化</p>
...
<article class="story-card secondary">
  ...
  <h3>Claudeボット構築教程</h3>
  <p class="story-summary">Polymarket取引ボット作成のステップバイステップ実践ガイド</p>
  <div class="story-links"><a href="https://x.com/RoundtableSpace/status/2034250223271182703" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card brief">
  ...
  <h3>Claude Codeスキル10種</h3>
  <p class="story-summary">広告監査・レポート自動化スキル集。DTC業務即適用可能</p>
  <div class="story-links"><a href="https://x.com/mikefutia/status/2034290510748361099" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
...
<article class="story-card brief">
  ...
  <h3>企業AIエージェント報告</h3>
  <p class="story-summary">Deloitte調査: エージェント統治重要。業務再設計の現状分析</p>
  <div class="story-links"><a href="https://x.com/rseroter/status/2033961562239537526" target="_blank" rel="noopener">Xポスト</a></div>
