...
<section class="mag-hero">
  <div class="hero-main">
    ...
    <p class="hero-sub">2026-05-02号 — Claude Code・Prompt Engineering を中心に、実装に効く話題を編集</p>
    <p class="hero-lead">本日 2026-05-02 は、Claude Code・Prompt Engineering を中心に 5 件のトピックをお届けします。Grok が X 上から収集した最新の AI エージェント関連情報です。</p>
  </div>
...
<article class="story-card secondary">
  ...
  <h3>プロンプト新ガイド比較解説</h3>
  <p class="story-summary">Claude/OpenAI公式ガイド違いを解説。古い書き方無効理由明確</p>
  <div class="story-links"><a href="https://x.com/claudecode_lab/status/2050233989949182463" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>Claude Code学習リーディングリスト</h3>
  <p class="story-summary">GW向けレベル別資料公開。徹底習得に最適</p>
  <div class="story-links"><a href="https://x.com/kajikent/status/2049992308129734844" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card brief">
  ...
  <h3>Claude CodeでTikTok自動化</h3>
  <p class="story-summary">バズ分析→画像生成→予約投稿のハイブリッド運用法</p>
  <div class="story-links"><a href="https://x.com/masahirochaen/status/2050049067057807413" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
...
<article class="story-card brief">
  ...
  <h3>Claude Code活用GWタスクリスト</h3>
  <p class="story-summary">開発・SEO自動化・自動トレードなど7事例で業務効率化</p>
  <div class="story-links"><a href="https://x.com/masahirochaen/status/2050226664186183689" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
</div>
</section>
