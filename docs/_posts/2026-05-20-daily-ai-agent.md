...
<section class="mag-hero">
  <div class="hero-main">
    ...
    <p class="hero-sub">2026-05-20号 — Claude Code を中心に、実装に効く話題を編集</p>
    <p class="hero-lead">本日 2026-05-20 は、Claude Code を中心に 3 件のトピックをお届けします。Grok が X 上から収集した最新の AI エージェント関連情報です。</p>
  </div>
...
<article class="story-card lead">
  ...
  <h3>Claude Code日本入門</h3>
  <p class="story-summary">とほほのClaude Code入門、インストール・コマンド・skills完全網羅。</p>
  <div class="story-links"><a href="https://x.com/jujulife7/status/2056718375221592401" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>Karpathy Anthropic参画</h3>
  <p class="story-summary">バイブコーディング提唱者がClaude Code本丸へ、AIコーディング未来示唆。</p>
  <div class="story-links"><a href="https://x.com/ImAI_Eruel/status/2056763383555502312" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
...
<article class="story-card secondary">
  ...
  <h3>TDD Claude cheatsheet</h3>
  <p class="story-summary">24時間オンboarding、テスト駆動ループとコンテキスト管理実践Tips。</p>
  <div class="story-links"><a href="https://x.com/coder_surya/status/2056337807967477855" target="_blank" rel="noopener">Xポスト</a></div>
