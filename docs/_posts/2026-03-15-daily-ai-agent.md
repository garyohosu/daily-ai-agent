...
<article class="story-card lead">
  ...
  <h3>コーディング自動化ツール</h3>
  <p class="story-summary">sharehtmlでMD/スライドをDocs風、Cloudflareデプロイ</p>
  <div class="story-links"><a href="https://x.com/akaphill/status/2032827975071314251" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>Claude Code実践Tips</h3>
  <p class="story-summary">音声メモ10分で計画モード起動、初心者活用法</p>
