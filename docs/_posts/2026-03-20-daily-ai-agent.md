...
<article class="story-card lead">
  ...
  <h3>Claude Code Dispatch公開</h3>
  <p class="story-summary">Anthropic公式がCodeセッションをDispatchで起動可能に</p>
  <div class="story-links"><a href="https://x.com/felixrieseberg/status/2034381385134399913" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>CLAUDE.md公式活用</h3>
  <p class="story-summary">Anthropic内部ファイルで計画・バグ修正を自動化</p>
  <div class="story-links"><a href="https://x.com/alifcoder/status/2034486920525582512" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>Claude Code feature-dev活用</h3>
  <p class="story-summary">公式機能で要件深掘り、開発効率とモチベ向上</p>
  <div class="story-links"><a href="https://x.com/tonkotsuboy_com/status/2034177733375430667" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
</div>
  </div>
...
引き続き **Claude Code・Workflow・Skills** の動向に注目していきます。
</p>
</section>
