...
<section class="mag-hero">
  <div class="hero-main">
    ...
    <p class="hero-sub">2026-06-10号 — Claude Code を中心に、実装に効く話題を編集</p>
    <p class="hero-lead">本日 2026-06-10 は、Claude Code を中心に 3 件のトピックをお届けします。Grok が X 上から収集した最新の AI エージェント関連情報です。</p>
  </div>
...
<article class="story-card lead">
  ...
  <h3>Code with Claude Tokyoイベント</h3>
  <p class="story-summary">日本開催のAnthropic技術イベントでClaude Code最新情報・エージェント実践共有。</p>
  <div class="story-links"><a href="https://x.com/oikon48/status/2064300421829763574" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>AIネイティブ組織構築</h3>
  <p class="story-summary">Anthropicガイド：Claude Code dogfoodingで役割流動化・プロセス廃止の実践。</p>
  <div class="story-links"><a href="https://x.com/YShimogawara/status/2063003677984706692" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
...
<article class="story-card secondary">
  ...
  <h3>Claude Code GitHub連携</h3>
  <p class="story-summary">Codex/Claude CodeとGitHub連携で保存・継続開発・自動化を実現する日本向けTips。 ...</p>
  <div class="story-links"><a href="https://x.com/mirai_spark/status/2064295577597395382" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
</div>
  </div>
