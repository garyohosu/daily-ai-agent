...
<section class="mag-hero">
  <div class="hero-main">
    ...
    <p class="hero-sub">2026-06-14号 — Claude Code を中心に、実装に効く話題を編集</p>
    <p class="hero-lead">本日 2026-06-14 は、Claude Code を中心に 2 件のトピックをお届けします。Grok が X 上から収集した最新の AI エージェント関連情報です。</p>
  </div>
...
<article class="story-card lead">
  ...
  <h3>Figma+Claudeでランディングクローン</h3>
  <p class="story-summary">FigmaキャプチャをClaude Codeで自社ブランド再構築。15分で完了の実践Tips。</p>
  <div class="story-links"><a href="https://x.com/mikefutia/status/2065537778516205856" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>Omnigentメタハーネス</h3>
  <p class="story-summary">Claude Code/Codex超えのマルチエージェント構築オープンソース。企業採用向き。</p>
  <div class="story-links"><a href="https://x.com/matei_zaharia/status/2065827057624605146" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
</div>
  </div>
