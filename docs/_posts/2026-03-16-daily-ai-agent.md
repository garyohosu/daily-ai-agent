...
<article class="story-card secondary">
  ...
  <h3>AIコーディングエージェントスキル</h3>
  <p class="story-summary">Neon DB向け新スキルでPostgres egress billパターン検出。コスト最適化実践Tips</p>
  <div class="story-links"><a href="https://x.com/MikaelLirbank/status/2033259319815467280" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>AIコーディングモデル比較</h3>
  <p class="story-summary">ベンチマーク基準でモデル選定解説。企業採用時の誤選択回避とワークフロー変更例 ...</p>
  <div class="story-links"><a href="https://x.com/TheCryptoLif7/status/2033205247976292683" target="_blank" rel="noopener">Xポスト</a></div>
...
引き続き **Claude Code・Skills・Enterprise** の動向に注目していきます。
</p>
</section>
