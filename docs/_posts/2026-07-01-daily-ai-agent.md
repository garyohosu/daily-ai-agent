...
<section class="mag-hero">
  <div class="hero-main">
    ...
    <p class="hero-sub">2026-07-01号 — Claude Code・AI Agents を中心に、実装に効く話題を編集</p>
    <p class="hero-lead">本日 2026-07-01 は、Claude Code・AI Agents を中心に 4 件のトピックをお届けします。Grok が X 上から収集した最新の AI エージェント関連情報です。</p>
  </div>
...
<article class="story-card lead">
  ...
  <h3>X公式MCPでAgent強化</h3>
  <p class="story-summary">X hosted MCP公開。Grok/Cursor/Claude/VS Codeでリアルタイム検索・トレンド活用可能に。</p>
  <div class="story-links"><a href="https://x.com/XFreeze/status/2071801039167336638" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>Claude Code公式拡張</h3>
  <p class="story-summary">Anthropic公式claude-code-setup拡張でプロジェクト自動スキャン・スキル設定・エコシステム構築。 ...</p>
  <div class="story-links"><a href="https://x.com/AdelDeveloperX/status/2072032331074838657" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>Claude Code用AI Agency</h3>
  <p class="story-summary">オープンソースのClaude Code用フルチームAgency。16部門の専門エージェントを1インストールで即活用。</p>
  <div class="story-links"><a href="https://x.com/JafarNajafov/status/2071881999263186991" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
</div>
  </div>
...
<article class="story-card brief">
  ...
  <h3>Claude Code + Sonnet 5活用</h3>
  <p class="story-summary">Sonnet 5をClaude Code Dynamic Workflowsで活用。複雑タスクにUltracodeモード推奨。</p>
  <div class="story-links"><a href="https://x.com/daniel_mac8/status/2072036584635977819" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
</div>
</section>
