...
<article class="story-card lead">
  ...
  <h3>Claude Code設定Tips</h3>
  <p class="story-summary">Claude Codeのセッションファイル永続化方法 cleanupPeriodDaysを9999に設定しデータ保持を推奨</p>
  <div class="story-links"><a href="https://x.com/tenobrus/status/2058637806176702831" target="_blank" rel="noopener">Xポスト</a></div>
...
<article class="story-card secondary">
  ...
  <h3>Claude Code自動運用</h3>
  <p class="story-summary">Claude Codeを24時間自動実行でバグ修正 状態ファイルとcron活用のワークフロー共有</p>
  <div class="story-links"><a href="https://x.com/brunobertolini/status/2058617644769493017" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
...
<article class="story-card secondary">
  ...
  <h3>AIコーディングエージェント文脈</h3>
  <p class="story-summary">コードベースを対話型グラフ化するオープンソースツール Claude Code対応</p>
  <div class="story-links"><a href="https://x.com/Saboo_Shubham_/status/2058269167372153129" target="_blank" rel="noopener">Xポスト</a></div>
