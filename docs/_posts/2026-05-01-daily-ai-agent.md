...
<article class="story-card secondary">
  ...
  <h3>ハッカソン勝者手法</h3>
  <p class="story-summary">マルチエージェント・持続記憶の実務オーケストレーション解説</p>
...
<article class="story-card brief">
  ...
  <h3>Claude Code学習4記事</h3>
  <p class="story-summary">Skills・MCP・プラグイン・運用ベストプラクティス保存版</p>
  <div class="story-links"><a href="https://x.com/ClaudeCode_love/status/2049491275418931238" target="_blank" rel="noopener">Xポスト</a></div>
  <div class="editor-note"><span>Editor's Note</span>Claude Code ユーザー必見。実装・ワークフロー改善に直結する情報。</div>
</article>
...
<article class="story-card brief">
  ...
  <h3>プラグイン導入順序</h3>
  <p class="story-summary">基盤→スタック→自動化段階的Tipsで実務混乱回避</p>
  <div class="story-links"><a href="https://x.com/ClaudeCode_love/status/2049800176878174315" target="_blank" rel="noopener">Xポスト</a></div>
